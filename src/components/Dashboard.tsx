...
const Dashboard: React.FC = () => {
  ...
  const filteredScreens = useMemo(() => {
    return screens.filter(screen =>
      (screen.caption?.toLowerCase() || '').includes(searchQuery.toLowerCase()) ||
      ...
      <div style={{
        ...
        <div style={styles.tabs}>
          {[
            ...
            { id: 'screens', label: 'Screens', icon: <FaMobileAlt /> },
