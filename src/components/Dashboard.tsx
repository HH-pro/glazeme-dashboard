...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="dashboard-container">
      ...
      {/* Demo Container Styles - FIXED FOR MOBILE */}
      <style>{`
        .demo-container {
          width: 100%;
          min-height: 500px;
        ...
        /* Mobile Responsive Demo Styles - FIXED */
        @media (max-width: 639px) {
          ...
          /* Ensure GlazeMeDemo component stays within bounds */
          .demo-content .glazemedemo-container {
            max-width: 100vw;
            overflow-x: auto;
          }
        }
...
export default Dashboard;import React, { useState, useEffect, useCallback, useMemo } from 'react';
import { db } from '../services/firebase';
import { collection, query, orderBy, onSnapshot, limit } from 'firebase/firestore';
import BuildUpdates from './BuildUpdates';
import ClientReview from './ClientReview';
